...
const Aside = ({ isSidebar, pathName }) => {
  return (
    <aside
      className={` ${
        isSidebar &&
        "transition-all duration-1000 lg:w-[260px] hidden xl:flex min-h-screen fixed top-0 left-0 bg-white lg:flex flex-col py-4 z-20 items-center justify-start border-[.5px]"
      } `}
    >
